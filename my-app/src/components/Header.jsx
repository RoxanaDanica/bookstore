...
function Header() {
    ...
    return (
        <div className="h-[121px]">
            <header
                className={` w-full bg-white border-b border-[#e5e5e5]  z-[99] transition-transform duration-300
                ${
                    sticky
                    ? "fixed top-0 left-0 right-0 shadow-md animate-[fixedAnim_0.9s_ease_both]"
                    : "relative"
                }

...
export default function Cart() {
  ...
  const filteredItems = useMemo(() => {
    return items.filter((item) => {
       ...
       */
      if (
        Array.isArray(filters.author) &&
        filters.author.length > 0
      ) {
        const itemAuthors = String(
          item.authors || ""
        )
          .split(";")
          .map((author) =>
      ...
      <div className="mx-auto max-w-[1400px] px-6">
        <div className="mb-10">
          ...
          <p className="mt-3 text-[15px] text-[#77716b]">
            Review your books and continue
            when you're ready.
          </p>
        </div>

        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[240px_1fr]">
          <aside className="h-fit rounded-2xl border border-[#e5dfd7] bg-white p-5 lg:sticky lg:top-[110px]">
            <SidebarFilters
              genres={genres}
              authors={authors}
              filters={filters}
          ...
          <div className="grid grid-cols-1 gap-8 xl:grid-cols-[1fr_360px]">
            <div>
              {filteredItems.length === 0 ? (
                <div className="rounded-2xl border border-[#e5dfd7] bg-white px-8 py-14 text-center">
                  <h2 className="font-['Playfair'] text-[26px] font-semibold text-[#171717]">
            ...
            <div className="h-fit xl:sticky xl:top-[110px]">
              <div className="rounded-2xl border border-[#e5dfd7] bg-white p-7 shadow-[0_10px_30px_rgba(0,0,0,0.04)]">
                ...
                <p className="mt-4 text-center text-xs leading-5 text-[#9b958f]">
                  Secure checkout. Your cart
                  is reserved while you
                  complete your order.
                </p>
              </div>
